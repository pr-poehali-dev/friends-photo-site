...
const PHOTOS = [
  ...
  {
    id: 20,
    src: "https://cdn.poehali.dev/files/4b256896-0c9d-45b0-98db-d9fa53b54734.jpg",
    author: "KSS",
    title: "Гитара",
    tags: ["уют", "музыка"],
    reactions: { "🔥": 48, "❤️": 62, "😮": 11 },
    comments: [
      { id: 1, author: "Аня", text: "Такой тёплый момент!", time: "1ч назад" },
    ],
  },
  {
    id: 21,
    src: "https://cdn.poehali.dev/files/c9f53668-6887-47f7-a4ec-9f11c05007aa.jpg",
    author: "KSS",
    title: "Баня vol.2",
    tags: ["баня", "тусовка"],
    reactions: { "🔥": 71, "❤️": 49, "😮": 26 },
    comments: [],
  },
  {
    id: 22,
    src: "https://cdn.poehali.dev/files/0598337b-7817-4b13-bad8-01c21bae8a6d.jpg",
    author: "KSS",
    title: "На закате",
    tags: ["закат", "улица"],
    reactions: { "🔥": 59, "❤️": 43, "😮": 17 },
    comments: [],
  },
  {
    id: 23,
    src: "https://cdn.poehali.dev/files/2d6e6f5c-73cc-4698-89e1-95187bf09fdd.jpg",
    author: "KSS",
    title: "На мото",
    tags: ["мото", "лето"],
    reactions: { "🔥": 88, "❤️": 66, "😮": 39 },
    comments: [
      { id: 1, author: "Дима", text: "Вот это кайф!", time: "30мин назад" },
    ],
  },
  {
    id: 24,
    src: "https://cdn.poehali.dev/files/8fad17eb-ae5c-4763-9717-a48fd85d3ad1.jpg",
    author: "KSS",
    title: "У театра vol.2",
    tags: ["ночь", "город"],
    reactions: { "🔥": 53, "❤️": 44, "😮": 20 },
    comments: [],
  },
  {
    id: 25,
    src: "https://cdn.poehali.dev/files/57130f73-8c25-401f-a67b-9954d0620b59.jpg",
    author: "KSS",
    title: "Выставка",
    tags: ["культура", "вместе"],
    reactions: { "🔥": 36, "❤️": 41, "😮": 9 },
    comments: [],
  },
  {
    id: 26,
    src: "https://cdn.poehali.dev/files/b20477cb-6ae4-4222-8d74-ebbde139f6ce.jpg",
    author: "KSS",
    title: "Мото в городе",
    tags: ["мото", "улица"],
    reactions: { "🔥": 74, "❤️": 55, "😮": 32 },
    comments: [],
  },
  {
    id: 27,
    src: "https://cdn.poehali.dev/files/dd2899d6-ac37-4366-b23e-db18fc628559.jpg",
    author: "KSS",
    title: "В парке",
    tags: ["лето", "вместе"],
    reactions: { "🔥": 42, "❤️": 37, "😮": 13 },
    comments: [],
  },
  {
    id: 28,
    src: "https://cdn.poehali.dev/files/8524f83a-c154-4bec-874f-1db5e216e284.jpg",
    author: "KSS",
    title: "Новый год",
    tags: ["новый год", "город"],
    reactions: { "🔥": 91, "❤️": 78, "😮": 44 },
    comments: [
      { id: 1, author: "Лена", text: "Огни просто сказка!", time: "2ч назад" },
    ],
  },
  {
    id: 29,
    src: "https://cdn.poehali.dev/files/6760c567-c8b9-4034-ae86-6a196a114021.jpg",
    author: "KSS",
    title: "Паркинг",
    tags: ["лето", "улица"],
    reactions: { "🔥": 31, "❤️": 26, "😮": 8 },
  ...
  {
    id: 30,
    src: "https://cdn.poehali.dev/files/0f4e5cdd-d9c7-4bd7-bde7-bcc1bcb6eeab.jpg",
    author: "KSS",
    title: "Ночная прогулка с псом",
    tags: ["ночь", "улица"],
    reactions: { "🔥": 38, "❤️": 33, "😮": 10 },
    comments: [],
  },
  {
    id: 31,
    src: "https://cdn.poehali.dev/files/097325d7-1bbe-4984-b68b-2a576f57ca3b.jpg",
    author: "KSS",
    title: "Winline vol.2",
    tags: ["тусовка", "лето"],
    reactions: { "🔥": 65, "❤️": 51, "😮": 27 },
    comments: [],
  },
  {
    id: 32,
    src: "https://cdn.poehali.dev/files/73d2cc62-0401-4a26-8a4c-918851fd0fda.jpg",
    author: "KSS",
    title: "Трое",
    tags: ["уют", "вместе"],
    reactions: { "🔥": 44, "❤️": 58, "😮": 12 },
    comments: [],
  },
  {
    id: 33,
    src: "https://cdn.poehali.dev/files/a151e5ed-f6f5-43e4-a56d-107ea0c1fc33.jpg",
    author: "KSS",
    title: "Зимний поход",
    tags: ["зима", "вместе"],
    reactions: { "🔥": 77, "❤️": 61, "😮": 29 },
    comments: [
      { id: 1, author: "Макс", text: "Вся банда в сборе!", time: "2ч назад" },
    ],
  },
  {
    id: 34,
    src: "https://cdn.poehali.dev/files/23dfef1f-65aa-4f4b-b5e3-7adbd2fec0d9.jpg",
    author: "KSS",
    title: "Вечер",
    tags: ["тусовка", "улица"],
    reactions: { "🔥": 36, "❤️": 29, "😮": 9 },
  ...
  {
    id: 35,
    src: "https://cdn.poehali.dev/files/b2b6376d-f4da-4d78-974e-923da0b187d2.jpg",
    author: "KSS",
    title: "На остановке",
    tags: ["зима", "улица"],
    reactions: { "🔥": 52, "❤️": 43, "😮": 18 },
    comments: [],
  },
  {
    id: 36,
    src: "https://cdn.poehali.dev/files/24c05d3d-a783-4988-bb11-9791ad777a33.jpg",
    author: "KSS",
    title: "Вечеринка",
    tags: ["тусовка", "ночь"],
    reactions: { "🔥": 68, "❤️": 55, "😮": 31 },
    comments: [],
  },
  {
    id: 37,
    src: "https://cdn.poehali.dev/files/275d2edc-1b45-456d-af65-86941b64089d.jpg",
    author: "KSS",
    title: "Дома",
    tags: ["уют", "вместе"],
    reactions: { "🔥": 33, "❤️": 47, "😮": 8 },
  ...
  {
    id: 38,
    src: "https://cdn.poehali.dev/files/10f38c19-7617-47f2-8c4d-a6d3715f2f65.jpg",
    author: "KSS",
    title: "У машины",
    tags: ["зима", "улица"],
    reactions: { "🔥": 41, "❤️": 34, "😮": 14 },
    comments: [],
  },
  {
    id: 39,
    src: "https://cdn.poehali.dev/files/af29b1eb-8e29-476b-8ef7-b0c4ea4e3e43.jpg",
    author: "KSS",
    title: "Нёрф",
    tags: ["тусовка", "уют"],
    reactions: { "🔥": 57, "❤️": 48, "😮": 22 },
    comments: [],
  },
  {
    id: 40,
    src: "https://cdn.poehali.dev/files/74a67562-fbcf-4c95-965d-fa14280f5829.jpg",
    author: "KSS",
    title: "Ночная тусовка",
    tags: ["ночь", "вместе"],
    reactions: { "🔥": 63, "❤️": 52, "😮": 24 },
    comments: [],
  },
];
